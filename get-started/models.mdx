...
| ----------------- | ------------------ | :----------------- | --------------------------------------------------------------------------------------- | -------------- | ---------------------------------- |
| **Mercury**       | \$0.25 / 1M tokens | \$1.00 / 1M tokens | `v1/chat/completions`                                                                   | 128K           | `Tool Calling` `Structured Output` |
| **Mercury Coder** | \$0.25 / 1M tokens | \$1.00 / 1M tokens | `v1/chat/completions` `v1/fim/completions` `v1/apply/completions` `v1/edit/completions` | 128K           | `Tool Calling` `Structured Output` |
