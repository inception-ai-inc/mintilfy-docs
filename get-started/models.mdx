...
| ----------------- | ----------------------- | :----------------------- | --------------------------------------------------------------------------------------- | -------------- | ---------------------------------- | ----------------- |
| **Mercury**       | \$0.25                  | \$1.00                   | `v1/chat/completions`                                                                   | 128K           | `Tool Calling` `Structured Output` | `Text`            |
| **Mercury Coder** | \$0.25                  | \$1.00                   | `v1/chat/completions` `v1/fim/completions` `v1/apply/completions` `v1/edit/completions` | 128K           | `Tool Calling` `Structured Output` | `Text`            |
