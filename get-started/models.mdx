...
<Tabs>
  <Tab title="Mercury">
    ...
    <ParamField path="presence_penalty" default="0.0" type="number">
    ...
    <ParamField path="realtime" default="false" type="boolean">
      Whether to provide a realtime, instant response.
    </ParamField>
